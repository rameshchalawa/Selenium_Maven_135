...
public class Demo_HandleStaticWebTable {
	...
	public static void main(String[] args) {
		...
		for(int r=2;r<=rows;r++)
		{
		   ...
		   {
			 //we can not pass directly variable inside xpath, hence we need to write "+r+" "+c+"
		...
		for(int r=2;r<=rows;r++)
		{
			...
			total=total+Integer.parseInt(price); //Here to convert price string value to int we have used Integer.parseInt(price)
		}
