...
public class Demo_HandleDatePicker {
	...
	public static void main(String[] args) {
		...
		selectFutureDate(driver,year,month,date); //calling userdefined method to select future date
		//selectPastDate(driver,year,month,date); //calling userdefined method to select past date
