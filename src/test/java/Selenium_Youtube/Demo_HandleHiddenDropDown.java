...
public class Demo_HandleHiddenDropDown {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//clicked on dropdown
		driver.findElement(By.xpath("/html/body/div/div[1]/div[2]/div[2]/div/div[1]/div[2]/form/div[1]/div/div[6]/div/div[2]/div/div")).click(); //we need to pause debugger to freeze screen to capture dropdown option xpath
		Thread.sleep(5000);
